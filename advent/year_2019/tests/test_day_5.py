...
def test_computer_output():
    ...
    assert computer.process([7]) == (True, [7])

def test_computer_jump_1():
    computer = Computer("3,9,8,9,10,9,4,9,99,-1,8")
    assert computer.process([8]) == (True, [1])
    computer.reset()
    assert computer.process([7]) == (True, [0])

def test_computer_jump_2():
    computer = Computer("3,9,7,9,10,9,4,9,99,-1,8")
    assert computer.process([7]) == (True, [1])
    computer.reset()
    assert computer.process([8]) == (True, [0])
...
def test_computer_jump_5():
    ...
    assert computer.process([0]) == (True, [0])
    computer.reset()
    assert computer.process([1]) == (True, [1])
...
def test_computer_jump_7():
    ...
    assert computer.process([7]) == (True, [999])
    computer.reset()
    assert computer.process([8]) == (True, [1000])
    computer.reset()
    assert computer.process([9]) == (True, [1001])